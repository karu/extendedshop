jQuery.fn.accessNews = function(settings) {
    ...
    return this.each(function(i) {
        aNewsSlider.itemWidth = parseInt(jQuery(".item:eq(" + i + ")",".product_slider").css("width")) + parseInt(jQuery(".item:eq(" + i + ")",".product_slider").css("margin-right"));
...
var aNewsSlider = {
    ...
    init: function(s,p) {
        ...
        if (jQuery(".view_all",p).width() == null) {
            jQuery(".product_items",p).prepend("<p class='view_all'>" + s.newsHeadline + " [ " + itemLength + " prodotti ] &nbsp;-&nbsp; <a href='#'>Visualizza tutti</a></p>");
        }
    ...
    vAll: function(s,p) {
        ...
        if (jQuery(o).text().indexOf("Visualizza tutti") != -1) {
            jQuery(".next",p).css("display","none");
            jQuery(".prev",p).css("display","none");
            jQuery(o).text("Vista ridotta");
            jQuery(".container",p).css("left","0px").css("width",aNewsSlider.itemWidth * 2 + "px");
        } else {
            jQuery(o).text("Visualizza tutti");
